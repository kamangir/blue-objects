...
🌀 `blue-objects` are the inputs and outputs of AI algo. They are maintained in [AWS S3](https://aws.amazon.com/s3/) and their metadata is tracked by [MLflow](https://mlflow.org/).
...
built by 🌀 [`blue_options-4.76.1-abcli-current`](https://github.com/kamangir/awesome-bash-cli), based on 🌀 [`blue_objects-5.89.1`](https://github.com/kamangir/blue-objects).
